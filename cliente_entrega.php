...
<DIV CLASS="nome_pag">Clientes - Entrega</DIV>
...
?>
	<TR>
		<TD STYLE="width: 0.01%;"><IMG SRC="imagens/cadernetas_seta.gif" onClick="window.open('cliente_edit_entrega.php?id_cliente=<?=mysql_result($clientes,$n,'ID');?>','_self');" TITLE="Editar"></TD>
