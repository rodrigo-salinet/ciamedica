...
<DIV CLASS="nome_pag">Clientes Para Venda</DIV>
...
?>
	<TR>
		<TD STYLE="width: 0.01%;"><IMG SRC="imagens/cadernetas_seta.gif" onClick="window.open('venda_sel_cli.php?id_cliente=<?=mysql_result($clientes,$n,'ID');?>','_self');" TITLE="Selecionar"></TD>
		<TD><A HREF="venda_sel_cli.php?id_cliente=<?=mysql_result($clientes,$n,'ID');?>"><?=mysql_result($clientes,$n,'NOME');?></A></TD>
