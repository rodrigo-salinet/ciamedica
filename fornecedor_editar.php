...
function valida_form() {
	var frm_cad_for = document.getElementById('frm_cad_for');
...
?>
<DIV CLASS="nome_pag">Editar Fornecedor</DIV>
<FORM ACTION="fornecedor_atualizar.php" ID="frm_cad_for" METHOD="POST" NAME="frm_cad_for"> 
	<INPUT TYPE="HIDDEN" NAME="hdn_id_fornecedor" ID="hdn_id_fornecedor" VALUE="<?=@mysql_result($fornecedor,0,'ID');?>"> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_nome" TYPE="TEXT" CLASS="txt" ID="txt_nome" VALUE="<?=@mysql_result($fornecedor,0,'NOME');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_razao_social" TYPE="TEXT" CLASS="txt" ID="txt_razao_social" VALUE="<?=@mysql_result($fornecedor,0,'RAZAO_SOCIAL');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_contato" TYPE="TEXT" CLASS="txt" ID="txt_contato" VALUE="<?=@mysql_result($fornecedor,0,'CONTATO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_cpf_cnpj" TYPE="TEXT" CLASS="txt" ID="txt_cpf_cnpj" onBlur="return formata_campo(this);" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($fornecedor,0,'CPF_CNPJ');?>" SIZE="20" MAXLENGTH="18"></TD> 
						<TD CLASS="txt_novo">Inscrição Estadual:</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_inscricao_estadual" TYPE="TEXT" CLASS="txt" ID="txt_inscricao_estadual" VALUE="<?=@mysql_result($fornecedor,0,'INSCRICAO_ESTADUAL');?>" SIZE="16" MAXLENGTH="15"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_endereco" TYPE="TEXT" CLASS="txt" ID="txt_endereco" VALUE="<?=@mysql_result($fornecedor,0,'ENDERECO');?>" STYLE="width: 89%;"> Nº: <INPUT NAME="txt_numero" TYPE="TEXT" CLASS="txt" ID="txt_numero" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($fornecedor,0,'NUMERO');?>" SIZE="5" MAXLENGTH="4"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_complemento" TYPE="TEXT" CLASS="txt" ID="txt_complemento" VALUE="<?=@mysql_result($fornecedor,0,'COMPLEMENTO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_bairro" TYPE="TEXT" CLASS="txt" ID="txt_bairro" VALUE="<?=@mysql_result($fornecedor,0,'BAIRRO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_municipio" TYPE="TEXT" CLASS="txt" ID="txt_municipio" VALUE="<?=@mysql_result($fornecedor,0,'MUNICIPIO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_uf" TYPE="TEXT" CLASS="txt" ID="txt_uf" onKeyPress="filtra_letras();" onKeyUp="formata_uf();" VALUE="<?=@mysql_result($fornecedor,0,'UF');?>" SIZE="2" MAXLENGTH="2"></TD> 
						<TD CLASS="txt_novo">CEP:</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_cep" TYPE="TEXT" CLASS="txt" ID="txt_cep" onKeyUp="return formata_cep(this);" VALUE="<?=@mysql_result($fornecedor,0,'CEP');?>" SIZE="11" MAXLENGTH="10"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_fone" TYPE="TEXT" CLASS="txt" ID="txt_ddd_fone" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($fornecedor,0,'DDD_FONE');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_fone" TYPE="TEXT" CLASS="txt" ID="txt_fone" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($fornecedor,0,'FONE');?>" SIZE="10" MAXLENGTH="9"></TD> 
						<TD CLASS="txt_novo">Fax:</TD> 
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_fax" TYPE="TEXT" CLASS="txt" ID="txt_ddd_fax" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($fornecedor,0,'DDD_FAX');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_fax" TYPE="TEXT" CLASS="txt" ID="txt_fax" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($fornecedor,0,'FAX');?>" SIZE="10" MAXLENGTH="9"></TD> 
						<TD CLASS="txt_novo">Celular:</TD> 
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_celular" TYPE="TEXT" CLASS="txt" ID="txt_ddd_celular" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($fornecedor,0,'DDD_CELULAR');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_celular" TYPE="TEXT" CLASS="txt" ID="txt_celular" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($fornecedor,0,'CELULAR');?>" SIZE="10" MAXLENGTH="9"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_email_msn" TYPE="TEXT" CLASS="txt" ID="txt_email_msn" VALUE="<?=@mysql_result($fornecedor,0,'EMAIL');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_site" TYPE="TEXT" CLASS="txt" ID="txt_site" VALUE="<?=@mysql_result($fornecedor,0,'SITE');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><TEXTAREA NAME="txt_obs" ROWS="2" CLASS="txt" ID="txt_obs" STYLE="width: 100%;"><?=@mysql_result($fornecedor,0,'OBS');?></TEXTAREA></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
...
<?
if (@mysql_num_rows($fornecedor) > 0) {
	$botao = 'Atualizar';
} else {
	$botao = 'Cadastrar';
}
?>
				...
				<INPUT TYPE="BUTTON" VALUE="Cancelar" onClick="window.open('fornecedor_todos.php','fornecedores');">
			</TD> 
		</TR> 
	</TABLE> 
</FORM> 
