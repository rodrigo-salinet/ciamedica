...
?>
<DIV CLASS="nome_pag">Informações sobre a Cotação &nbsp;&nbsp; <IMG SRC="imagens/impressora.gif" STYLE="cursor: hand;" onClick="window.open('cotacao_imprimir.php?id_tipo=<?=$id_tipo;?>&id_cotacao=<?=$id_cotacao?>','impressao','fullscreen');"> &nbsp;</DIV>
...
<? 		@mysql_free_result($medida); ?>
						<TD CLASS="cotacao"><?=@mysql_result($itens,$n,'PRECO');?></TD>
