...
<? $id_nivel = trim(@$_GET['sel_tipo']); ?>
<? $id_tipo = trim(@$_GET['sel_tipo']); ?>
<HTML>
<HEAD>
...
<DIV CLASS="nome_pag">Clientes Para Cotação</DIV>
...
?>
	<TR>
		<TD STYLE="width: 0.01%;"><IMG SRC="imagens/cadernetas_seta.gif" onClick="window.open('cotacao_sel_cli.php?id_nivel=<?=$id_nivel;?>&id_tipo=<?=$id_tipo;?>id_cliente=<?=mysql_result($clientes,$n,'ID');?>','_self');" TITLE="Selecionar"></TD>
		<TD><A HREF="cotacao_sel_cli.php?id_nivel=<?=$id_nivel;?>&id_tipo=<?=$id_tipo;?>&id_cliente=<?=mysql_result($clientes,$n,'ID');?>"><?=mysql_result($clientes,$n,'NOME');?></A></TD>
