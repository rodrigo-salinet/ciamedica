...
$sql_cob_cliente = "SELECT * FROM DADOS_CLIENTE WHERE ID_CLIENTE=$hdn_id_cliente";
...
if (mysql_query($sql_string,$conexao)) {
	...
	$msg = "Dados de cobrança do cliente $nome_cliente $foi com sucesso.";
} else {
	$executar = 'cadastrar';
	if ($existe == true) {
		$executar = 'atualizar';
	}
	$msg = "Ocorreu um problema ao $executar dados de cobrança do cliente $nome_cliente.";
}
