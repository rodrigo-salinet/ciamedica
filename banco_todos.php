...
function excluir(id,nome) {
	if (window.confirm('Esta ação irá excluir definitivamente o banco ' + nome + '.') == true) {
...
?>
	<TR>
		<TD COLSPAN="6" STYLE="text-align: center;">Não há banco cadastrado nesta seção no momento.</TD>
	</TR>
<?
} else {
	$linha_inicial = 0;
