...
function valida_form() {
	var frm_cad_ven = document.getElementById('frm_cad_ven');
...
function excluir(id) {
	if (window.confirm('Esta ação irá excluir definitivamente o ítem nº ' + id + '.') == true) {
		window.open('venda_excluir_item.php?id_item=' + id,'_self');
	}
}
function total(txt) {
...
function adicionar_item() {
	var frm_cad_ven = document.getElementById('frm_cad_ven');
	var hdn_id_venda = document.getElementById('hdn_id_venda');
	var hdn_pag = document.getElementById('hdn_pag');
	var txt_nome = document.getElementById('txt_nome');
	var link_sel_cli = document.getElementById('link_sel_cli');
	if (trim(hdn_id_venda.value) != '') {
		window.open('venda_itens.php?id_venda=<?=$id_venda;?>','vendas');
	} else {
		if (trim(txt_nome.value) == '' || trim(txt_nome.value).length < 3) {
			alert('Preencha corretamente o campo NOME FANTASIA\nque deve conter no MÍNIMO 3 LETRAS\nou Selecione o Cliente');
			txt_nome.focus();
...
?>
<DIV CLASS="nome_pag">Editar Venda</DIV>
<FORM ACTION="venda_atualizar.php" ID="frm_cad_ven" METHOD="POST" NAME="frm_cad_ven"> 
	<INPUT TYPE="HIDDEN" NAME="hdn_id_venda" ID="hdn_id_venda" VALUE="<?=@mysql_result($venda,0,'ID');?>"> 
	<INPUT TYPE="HIDDEN" NAME="hdn_id_cliente" ID="hdn_id_cliente" VALUE="<?=@mysql_result($venda,0,'ID_CLIENTE');?>"> 
	...
	<TABLE STYLE="width: 100%;"> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_controle" TYPE="TEXT" CLASS="txt" ID="txt_controle" VALUE="<?=@mysql_result($venda,0,'CONTROLE');?>" SIZE="7" MAXLENGTH="6"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
		<TR> 
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						<TD CLASS="txt_novo">Nome Fantasia:<BR><A HREF="venda_clientes.php" TARGET="vendas" ID="link_sel_cli">Selecionar</A></TD> 
						<TD CLASS="campo"><INPUT NAME="txt_nome" TYPE="TEXT" CLASS="txt" ID="txt_nome" VALUE="<?=@mysql_result($venda,0,'CLI_NOME');?>" STYLE="width: 100%; cursor: hand;" onDblClick="window.open('cliente.php?id_cliente=<?=@mysql_result($venda,0,'ID_CLIENTE');?>','_self');"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_razao_social" TYPE="TEXT" CLASS="txt" ID="txt_razao_social" VALUE="<?=@mysql_result($venda,0,'CLI_RAZAO_SOCIAL');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_contato" TYPE="TEXT" CLASS="txt" ID="txt_contato" VALUE="<?=@mysql_result($venda,0,'CLI_CONTATO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_cpf_cnpj" TYPE="TEXT" CLASS="txt" ID="txt_cpf_cnpj" onBlur="return formata_campo(this);" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_CPF_CNPJ');?>" SIZE="20" MAXLENGTH="18"></TD> 
						<TD CLASS="txt_novo">Inscrição Estadual:</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_inscricao_estadual" TYPE="TEXT" CLASS="txt" ID="txt_inscricao_estadual" VALUE="<?=@mysql_result($venda,0,'CLI_INSCRICAO_ESTADUAL');?>" SIZE="16" MAXLENGTH="15"></TD> 
						<TD CLASS="txt_novo">CFOP:</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_cfop" TYPE="TEXT" CLASS="txt" ID="txt_cfop" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_CFOP');?>" SIZE="6" MAXLENGTH="5"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_endereco" TYPE="TEXT" CLASS="txt" ID="txt_endereco" VALUE="<?=@mysql_result($venda,0,'CLI_ENDERECO');?>" STYLE="width: 89%;"> Nº: <INPUT NAME="txt_numero" TYPE="TEXT" CLASS="txt" ID="txt_numero" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_NUMERO');?>" SIZE="5" MAXLENGTH="4"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_complemento" TYPE="TEXT" CLASS="txt" ID="txt_complemento" VALUE="<?=@mysql_result($venda,0,'CLI_COMPLEMENTO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_bairro" TYPE="TEXT" CLASS="txt" ID="txt_bairro" VALUE="<?=@mysql_result($venda,0,'CLI_BAIRRO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_municipio" TYPE="TEXT" CLASS="txt" ID="txt_municipio" VALUE="<?=@mysql_result($venda,0,'CLI_MUNICIPIO');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_uf" TYPE="TEXT" CLASS="txt" ID="txt_uf" onKeyPress="filtra_letras();" onKeyUp="formata_uf();" VALUE="<?=@mysql_result($venda,0,'CLI_UF');?>" SIZE="2" MAXLENGTH="2"></TD> 
						<TD CLASS="txt_novo">CEP:</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_cep" TYPE="TEXT" CLASS="txt" ID="txt_cep" onKeyUp="return formata_cep(this);" VALUE="<?=@mysql_result($venda,0,'CLI_CEP');?>" SIZE="11" MAXLENGTH="10"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_fone" TYPE="TEXT" CLASS="txt" ID="txt_ddd_fone" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_DDD_FONE');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_fone" TYPE="TEXT" CLASS="txt" ID="txt_fone" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($venda,0,'CLI_FONE');?>" SIZE="10" MAXLENGTH="9"></TD> 
						<TD CLASS="txt_novo">Fax:</TD> 
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_fax" TYPE="TEXT" CLASS="txt" ID="txt_ddd_fax" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_DDD_FAX');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_fax" TYPE="TEXT" CLASS="txt" ID="txt_fax" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($venda,0,'CLI_FAX');?>" SIZE="10" MAXLENGTH="9"></TD> 
						<TD CLASS="txt_novo">Celular:</TD> 
						<TD CLASS="campo">(<INPUT NAME="txt_ddd_celular" TYPE="TEXT" CLASS="txt" ID="txt_ddd_celular" onKeyPress="filtra_teclas();" VALUE="<?=@mysql_result($venda,0,'CLI_DDD_CELULAR');?>" SIZE="2" MAXLENGTH="2">) 
							<INPUT NAME="txt_celular" TYPE="TEXT" CLASS="txt" ID="txt_celular" onKeyPress="filtra_teclas();" onKeyUp="formata_fone();" VALUE="<?=@mysql_result($venda,0,'CLI_CELULAR');?>" SIZE="10" MAXLENGTH="9"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_email_msn" TYPE="TEXT" CLASS="txt" ID="txt_email_msn" VALUE="<?=@mysql_result($venda,0,'CLI_EMAIL');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_site" TYPE="TEXT" CLASS="txt" ID="txt_site" VALUE="<?=@mysql_result($venda,0,'CLI_SITE');?>" STYLE="width: 100%;"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
				...
				<TABLE STYLE="width: 100%;">
					<TR>
						<TD CLASS="txt_novo">Observações<BR>
							do Cliente:</TD> 
						<TD CLASS="campo"><TEXTAREA NAME="txt_obs_cliente" ROWS="2" CLASS="txt" ID="txt_obs_cliente" STYLE="width: 100%;"><?=@mysql_result($venda,0,'CLI_OBS');?></TEXTAREA></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
		...
		<TR> 
			<TD STYLE="white-space: nowrap; text-align: center;">
				<TABLE STYLE="width: 100%;">
<?
$sql_max_itens = "SELECT * FROM ITENS WHERE ID_TIPO=2 ORDER BY ID DESC";
...
$ver_itens = false;
if ($id_venda != '') {
	$sql_itens = "SELECT * FROM ITENS WHERE ID_TIPO=2 AND ID_TABELA=$id_venda";
...
?>
					<TR>
						<TD COLSPAN="2" CLASS="venda">Nº:</TD>
...
?>
					<TR>
						<TD CLASS="venda"><IMG SRC="imagens/x.gif" onClick="excluir('<?=mysql_result($itens,$n,'ID');?>');" TITLE="Excluir"></TD>
<?
...
?>
						...
						<TD CLASS="venda"><INPUT TYPE="TEXT" CLASS="txt" STYLE="text-align: center;" ID="txt_quantidade_<?=@mysql_result($itens,$n,'ID');?>" NAME="txt_quantidade_<?=@mysql_result($itens,$n,'ID');?>" onKeyPress="filtra_numeros();" onKeyUp="total(this);" onClick="analisa_total();" SIZE="7" MAXLENGTH="6" VALUE="<?=@mysql_result($itens,$n,'QUANTIDADE');?>"></TD>
<?
...
<? 		@mysql_free_result($medida); ?>
						<TD CLASS="venda"><INPUT TYPE="TEXT" CLASS="txt" STYLE="text-align: right;" ID="txt_preco_<?=@mysql_result($itens,$n,'ID');?>" NAME="txt_preco_<?=@mysql_result($itens,$n,'ID');?>" onKeyPress="moeda();" onKeyUp="total(this);" onClick="analisa_total();" SIZE="12" MAXLENGTH="11" VALUE="<?=@mysql_result($itens,$n,'PRECO');?>"></TD>
<? 		@mysql_free_result($produto); ?>
						<TD CLASS="venda"><INPUT TYPE="TEXT" CLASS="txt" STYLE="text-align: right;" ID="txt_desconto_<?=@mysql_result($itens,$n,'ID');?>" NAME="txt_desconto_<?=@mysql_result($itens,$n,'ID');?>" onKeyPress="desconto();" onKeyUp="total(this);" onClick="analisa_total();" SIZE="8" MAXLENGTH="7" VALUE="<?=@mysql_result($itens,$n,'DESCONTO');?>">%</TD>
						<TD CLASS="venda"><INPUT TYPE="TEXT" CLASS="txt" STYLE="text-align: right;" ID="txt_total_<?=@mysql_result($itens,$n,'ID');?>" NAME="txt_total_<?=@mysql_result($itens,$n,'ID');?>" onKeyPress="moeda();" onKeyUp="soma_total();" onClick="analisa_total();" SIZE="21" VALUE="<?=@mysql_result($itens,$n,'TOTAL');?>"></TD>
					</TR>
<?
	}
} else {
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_desconto" TYPE="TEXT" CLASS="txt" STYLE="text-align: right;" ID="txt_desconto" onKeyPress="desconto();" onKeyUp="soma_total();" onClick="analisa_total();" VALUE="<?=@mysql_result($venda,0,'DESCONTO');?>" SIZE="8" MAXLENGTH="7">%</TD> 
						<TD CLASS="txt_novo">Preço Total: R$</TD> 
						<TD CLASS="campo"><INPUT NAME="txt_preco_total" TYPE="TEXT" CLASS="txt" STYLE="text-align: right;" ID="txt_preco_total" onKeyPress="moeda();" onClick="analisa_total();" VALUE="<?=@mysql_result($venda,0,'PRECO_TOTAL');?>" SIZE="21"></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><INPUT NAME="txt_data_entrega" TYPE="TEXT" CLASS="txt" ID="txt_data_entrega" onKeyPress="filtra_teclas('/');" VALUE="<?=@mysql_result($venda,0,'DATA_ENTREGA');?>" SIZE="11" MAXLENGTH="10"></TD> 
...
$marca_nao = ' CHECKED';
$marca_sim = '';
if (@mysql_result($venda,0,'COMPLETA') == 'Sim') {
	$marca_sim = ' CHECKED';
	$marca_nao = '';
}
?>
			...
			<TD>
				<TABLE STYLE="width: 100%;">
					<TR>
						...
						<TD CLASS="campo"><TEXTAREA NAME="txt_obs" ROWS="2" CLASS="txt" ID="txt_obs" STYLE="width: 100%;"><?=@mysql_result($venda,0,'OBS');?></TEXTAREA></TD> 
					</TR>
				</TABLE>
			</TD>
		</TR> 
...
?>
				...
				<INPUT TYPE="BUTTON" VALUE="Cancelar" onClick="window.open('venda_todas.php','vendas');">
			</TD> 
		</TR> 
	</TABLE> 
</FORM> 
...
<? if (trim(@mysql_result($venda,0,'PRECO_TOTAL')) == '') { ?>
soma_total();
<? } ?>
</SCRIPT> 
