...
function excluir(id,nome) {
	if (window.confirm('Esta ação irá excluir definitivamente a medida ' + nome + '.') == true) {
...
?>
	<TR>
		<TD COLSPAN="4" STYLE="text-align: center;">Não há medida cadastrado nesta seção no momento.</TD>
	</TR>
<?
} else {
	$linha_inicial = 0;
